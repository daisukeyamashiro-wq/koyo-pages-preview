(function () {
  ...
  const form = document.querySelector("#koyo-lcl-form");
  const cbmInput = document.querySelector("#koyo-lcl-cbm");
  const weightInput = document.querySelector("#koyo-lcl-weight");
  const destinationInput = document.querySelector("#koyo-lcl-destination");
  ...
  const remarksInput = document.querySelector("#koyo-lcl-remarks");
  const errorBox = document.querySelector("#koyo-lcl-error");
  const resultCard = document.querySelector("#koyo-lcl-result");
  const emptyState = document.querySelector("#koyo-lcl-empty");
  const resultBody = document.querySelector("#koyo-lcl-result-body");
  const mailButton = document.querySelector("#koyo-lcl-mail-button");

  const resultNodes = {
    destination: document.querySelector("#koyo-lcl-result-destination"),
    cbm: document.querySelector("#koyo-lcl-result-cbm"),
    weight: document.querySelector("#koyo-lcl-result-weight"),
    rt: document.querySelector("#koyo-lcl-result-rt"),
    riskLevel: document.querySelector("#koyo-lcl-risk-level"),
    diagnosisStatus: document.querySelector("#koyo-lcl-diagnosis-status"),
    diagnosisList: document.querySelector("#koyo-lcl-diagnosis-list"),
    destinationNote: document.querySelector("#koyo-lcl-destination-note"),
    requiredList: document.querySelector("#koyo-lcl-required-list"),
    cautionList: document.querySelector("#koyo-lcl-caution-list"),
    japanCost: document.querySelector("#koyo-lcl-japan-cost"),
    japanCostMain: document.querySelector("#koyo-lcl-japan-cost-main"),
    japanCostNote: document.querySelector("#koyo-lcl-japan-cost-note"),
  };
  ...
  function updateResultClass(level) {
    resultCard.classList.remove("koyo-lcl-result-neutral", "koyo-lcl-result-normal", "koyo-lcl-result-warning", "koyo-lcl-result-danger");
    resultCard.classList.add(`koyo-lcl-result-${level}`);
  }
